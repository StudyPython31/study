...
class LiveStartPage(common.Action):
    livebtn_loc = 'com.xxxx:id/img_live' #直播按钮
    liveopen_loc = 'com.xxxx:id/iv_start_live' #公开直播按钮
    liveprivate_loc = 'com.xxxx:id/iv_private_space' #私密直播按钮
    '''开始直播页面'''
    startlivebtn_loc = 'com.xxxx:id/startLive' #开始直播
    pwd_loc = 'com.xxxx:id/tv_import_password' #私密直播密码
    comfirmbtn_loc = 'com.xxxx:id/btn_affirm_password' #私密直播确认按钮
    closelive_loc = 'com.xxxx:id/ivClose' #关闭直播间
    closecomfirm_loc = 'com.xxxx:id/tvSure'#关闭直播间弹框确认按钮
    livestopbtn_loc = 'com.xxxx:id/btnConfirm' #直播结束页面
